...
plot_PURACB <- ggplot(result, aes(x = `Num.of.Markers`, y = Accuracy, shape = factor(Type), color = factor(`Num.of.Individuals`))) +
  geom_point(size = 3) +
...
ggsave("plot_PURACB.png",width = 10, height = 8, dpi = 300)
```
